...
const workbook = XLSX.readFile('./трофим!.xlsx');
...
fs.writeFileSync('./src/data9.js', output, 'utf8');
console.log('🚀 Файл data9.js успешно сгенерирован! В нем ' + tasks.length + ' задач.');